...
public class MyBotServiceRus {
    public SendMessage asosiyMenuRus(Long chatId){
        ...
        button1.setText("\uD83D\uDCDDРуководство");
        row1.add(button1);
        rowList.add(row1);
        KeyboardButton button2 = new KeyboardButton();
        button2.setText("\uD83D\uDCB5Обменный курс");
        row1.add(button2);
        KeyboardButton button3 = new KeyboardButton();
        button3.setText("\uD83D\uDD10Почему с нами безопасно");
        row2.add(button3);
        rowList.add(row2);
        KeyboardButton button4 = new KeyboardButton();
        button4.setText("\uD83D\uDCC8Обзор случая CTRANS");
        row2.add(button4);
        KeyboardButton button5 = new KeyboardButton();
        button5.setText("⏰Срок поставки");
        row3.add(button5);
        rowList.add(row3);
        KeyboardButton button6 = new KeyboardButton();
        button6.setText("\uD83D\uDC68\u200D\uD83D\uDCBBСвяжитесь с менеджером");
        row3.add(button6);
        KeyboardButton button7 = new KeyboardButton();
        button7.setText("\uD83D\uDCCBУслуги");
        row4.add(button7);
        rowList.add(row4);
        KeyboardButton button8 = new KeyboardButton();
        button8.setText("\uD83D\uDCACОставить комментарий");
        row4.add(button8);
        KeyboardButton button9 = new KeyboardButton();
        button9.setText("\uD83E\uDDEEКалькулятор");
        row5.add(button9);
        rowList.add(row5);
        KeyboardButton button10 = new KeyboardButton();
        button10.setText("⚙\uFE0FНастройки");
        row6.add(button10);
        rowList.add(row6);
